...
layout: post
title: Proxy post
description: This description is specified in the post markdown.
category: This is the Category in the markdown
alt: A proxy image - will be something else in the future
published: true
